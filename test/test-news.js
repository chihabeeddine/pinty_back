...
let News = require('../API/database/methods/news');
...
const NEWS_ID = '5a7d2271377fb017725bbd20';
...
describe('News', function() {
  ...
  describe('GET /news/place/', function() {
    it('should get news by place ID on GET /news/place/:id/list', done => {
      chai
        .request(server)
        .get(`/news/place/${PLACE_ID}/list`)
    ...
    it('should not get news by place ID on GET /news/place/:id/list - pinty id is missing', done => {
      chai
        .request(server)
        .get(`/news/place/${PLACE_ID}/list`)
        .set('pinty_key', PINTY_KEY)
  ...
  describe('GET /news/user/', function() {
    it('should get news by user ID (subscribed news) on GET /news/user/:id/list', done => {
      chai
        .request(server)
        .get(`/news/user/${PINTY_ID}/list`)
        .set('pinty_id', PINTY_ID)
        .set('pinty_key', PINTY_KEY)
        .end((err, res) => {
          res.should.have.status(200);
    ...
    it('should not get news by user ID (subscribed news) on GET /news/user/:id/list - pinty id is missing', done => {
      chai
        .request(server)
        .get(`/news/user/${PINTY_ID}/list`)
        .set('pinty_key', PINTY_KEY)
  ...
  describe('PUT /news/create/', function() {
    it('should create a news on PUT /news/create/', done => {
      chai
        .request(server)
        .put('/news/create/')
        .set('pinty_id', PINTY_ID)
    ...
    it('should not create a news on PUT /news/create/ - pinty id is missing', done => {
      chai
        .request(server)
        .put('/news/create/')
        .set('pinty_key', PINTY_KEY)
  ...
  describe('PATCH /news', function() {
    it('should edit and get a news on PATCH /news/id/:id/edit/', done => {
      chai
        .request(server)
        .patch(`/news/id/${NEWS_ID}/edit/`)
        .set('pinty_id', PINTY_ID)
        .set('pinty_key', PINTY_KEY)
        .send({
          authorID: PINTY_ID,
    ...
    it('should not edit a news on PUT PATCH /news/id/:id/edit/ - pinty id is missing', done => {
      chai
        .request(server)
        .patch(`/news/id/${NEWS_ID}/edit/`)
        .set('pinty_key', PINTY_KEY)
  ...
  describe('DELETE /news', function() {
    it('should delete a news on DELETE /news/id/:id/delete/', done => {
      chai
        .request(server)
        .delete(`/news/id/${NEWS_ID}/delete`)
        .set('pinty_id', PINTY_ID)
        .set('pinty_key', PINTY_KEY)
        .end((err, res) => {
          res.should.have.status(200);
    ...
    it('should not delete a news on DELETE /news/id/:id/delete - pinty id is missing', done => {
      chai
        .request(server)
        .delete(`/news/id/${NEWS_ID}/delete`)
        .set('pinty_key', PINTY_KEY)
